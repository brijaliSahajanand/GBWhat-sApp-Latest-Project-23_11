...
public class FullImageAdapter extends PagerAdapter {
    ...
    public FullImageAdapter(Context context, ArrayList<WhatsappStatusModel> imageList) {
...
//        final ImageView im_delete = imageLayout.findViewById(R.id.im_delete);
        ...
        im_vpPlay.setOnClickListener(v -> {
            //context.startActivity(new Intent(context, ViewVideoScreen.class).putExtra("share", imageList.get(position).getPath()));
