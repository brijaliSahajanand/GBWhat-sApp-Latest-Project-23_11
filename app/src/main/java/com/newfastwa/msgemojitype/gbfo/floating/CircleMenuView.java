package com.newfastwa.msgemojitype.gbfo.floating;
...
public class CircleMenuView extends FrameLayout {
    ...
    private static final float DEFAULT_RING_SCALE_RATIO = 2.3f;
    private static final float DEFAULT_CLOSE_ICON_ALPHA = 1f;
    ...
    public CircleMenuView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        try {
            ...
            mIconMenu = a.getResourceId(R.styleable.CircleMenuView_icon_menu, R.drawable.round_corner_plus);
            mIconClose = a.getResourceId(R.styleable.CircleMenuView_icon_close, R.drawable.center_rounded_close);
            ...
            menuButtonColor = a.getColor(R.styleable.CircleMenuView_icon_color, Color.TRANSPARENT);
        } finally {
            a.recycle();
        }
    ...
    private Animator getOpenMenuAnimation() {
        ...
        final ValueAnimator buttonsAppear = ValueAnimator.ofFloat(1f, mDistance);
